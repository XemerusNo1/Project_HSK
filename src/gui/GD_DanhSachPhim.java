...
//		JSeparator separator = new JSeparator(SwingConstants.HORIZONTAL);
	...
	public void actionPerformed(ActionEvent e) {
	    ...
	    if (o.equals(btnDatVe1)) {
	        // Set the movie code here
	    	ThongTinDatVe.setMaPhim("P01");

	        // Navigate to GD_ThongTinPhim
	        ...
	        ThongTinDatVe.setSelectedDate(null);
	        ThongTinDatVe.setSelectedTime(null);
	    }
	    if (o.equals(btnDatVe2)) {
	        // Set the movie code here
	    	ThongTinDatVe.setMaPhim("P02");
	    ...
	    if (o.equals(btnDatVe3)) {
	        // Set the movie code here
	    	ThongTinDatVe.setMaPhim("P03");
	    ...
	    if (o.equals(btnDatVe4)) {
	        // Set the movie code here
	    	ThongTinDatVe.setMaPhim("P04");
	    ...
	    if (o.equals(btnDatVe5)) {
	        // Set the movie code here
	    	ThongTinDatVe.setMaPhim("P05");
	    ...
	    if (o.equals(btnDatVe6)) {
	        // Set the movie code here
	    	ThongTinDatVe.setMaPhim("P06");
	    ...
	    if (o.equals(btnDatVe7)) {
	        // Set the movie code here
	    	ThongTinDatVe.setMaPhim("P07");
	    ...
	    if (o.equals(btnDatVe8)) {
	        // Set the movie code here
	    	ThongTinDatVe.setMaPhim("P08");
