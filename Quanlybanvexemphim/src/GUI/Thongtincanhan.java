...
public class Thongtincanhan extends JFrame {
	...
	public Thongtincanhan() {
		...
		ImageIcon oricon = new ImageIcon("./src/image/user.jpg"); // Đường dẫn tương đối
...
//        ImageIcon iconchart = new ImageIcon(icon);
		...
		txtnamsinh.setForeground(Color.RED);
		...
		vaitro.setFont(font1);
		vaitro.setForeground(Color.RED);
		vaitro.setAlignmentX(Component.LEFT_ALIGNMENT); // Căn trái

		JLabel txtvaitro = new JLabel();
		txtvaitro.setFont(font1);
		txtvaitro.setForeground(Color.RED);
		txtvaitro.setAlignmentX(Component.LEFT_ALIGNMENT); // Căn trái
		...
		ImageIcon oricon1 = new ImageIcon("./src/image/user.jpg"); // Đường dẫn tương đối
